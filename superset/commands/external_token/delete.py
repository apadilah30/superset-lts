...
class DeleteExternalTokenCommand(BaseCommand):
    def __init__(self, model_ids: list[int]):
        self._model_ids = model_ids
        self._models: Optional[list[ExternalToken]] = None
    ...
    def run(self) -> None:
        ...
        try:
            ExternalTokenDAO.delete(self._models)
        except DAODeleteFailedError as ex:
            logger.exception(ex.exception)
            raise ExternalTokenDeleteFailedError() from ex
