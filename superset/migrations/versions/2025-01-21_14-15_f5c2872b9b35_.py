...
Revision ID: f5c2872b9b35
Revises: 8829ab1a9ad2
Create Date: 2025-01-21 14:15:45.947194

"""

# revision identifiers, used by Alembic.
revision = 'f5c2872b9b35'
down_revision = '8829ab1a9ad2'
...
def upgrade():
    ...
    op.alter_column('external_tokens', 'created_on',
               existing_type=postgresql.TIMESTAMP(),
               nullable=True)
    op.alter_column('external_tokens', 'changed_on',
               existing_type=postgresql.TIMESTAMP(),
               nullable=True)
    op.alter_column('external_tokens', 'uuid',
               existing_type=postgresql.UUID(),
               nullable=False)
    op.alter_column('external_tokens', 'user_id',
               existing_type=sa.INTEGER(),
               nullable=True)
    op.alter_column('external_tokens', 'token',
               existing_type=sa.TEXT(),
               nullable=True)
    op.alter_column('external_tokens', 'username',
               existing_type=sa.VARCHAR(length=250),
               nullable=True)
    op.alter_column('external_tokens', 'consumed',
               existing_type=sa.INTEGER(),
               nullable=True)
